...
<head>
    ...
    <link rel="icon" type="image/png" sizes="96x96" href="{{asset('assets/img/LOGO SELARAS 2.jpg')}}">
    ...
    <style>
        html, body {
            ...
            background: url('{{ asset('assets/img/bg-inventory.jpg') }}') no-repeat center center fixed;
    ...
    <div id="wrapper">
        <div class="vertical-align-wrap">
            <div class="auth-box">
                <div class="content">
                    <div class="header">
                        <h1 class="lead">Selaras Inventory Management System</h1>
                    </div>
...
<br>
					By : <a href=>Selaras Muba Lestari</a>
                </div>
            </div>
        </div>
    </div>
